  ...
  return (
    <View style={styles.container}>
      <View style={styles.displayContainer}>
        { result ? <Text style={[styles.displayText, {fontSize: 77, marginTop: -10}]}>{result}</Text> : <Text style={[styles.displayText, {fontSize: 77, marginTop: -10}]}>{input}</Text> }
      </View>
      <View style={styles.buttonContainer}>
        <View style={styles.row}>
          <TouchableOpacity onPress={() => handleClearPress()} style={[styles.button, {backgroundColor: '#CCCCCC'}]}>
            <Text style={[styles.buttonText, {color: 'black'}]}>AC</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.button, {backgroundColor: '#CCCCCC'}]}>
            <Text style={[styles.buttonText, {color: 'black'}]}></Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleOperatorPress('%')} style={[styles.button, {backgroundColor: '#CCCCCC'}]}>
            <Text style={[styles.buttonText, {color: 'black'}]}>%</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleOperatorPress('/')} style={[styles.button, , {backgroundColor: 'orange'}]}>
        ...
        <View style={styles.row}>
          <TouchableOpacity onPress={() => handleButtonPress('0')} style={styles.buttonZero}>
            <Text style={styles.buttonText}>0</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleButtonPress('.')} style={styles.button}>
            <Text style={styles.buttonText}>.</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleEqualPress()} style={styles.buttonEqual}>
            <Text style={styles.buttonText}>=</Text>
          </TouchableOpacity>
        </View>
      </View>
